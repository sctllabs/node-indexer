 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type DaoCouncilCall = DaoCouncilCall_propose | DaoCouncilCall_propose_with_meta | DaoCouncilCall_vote | DaoCouncilCall_close | DaoCouncilCall_close_scheduled_proposal
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type DaoTechnicalCommitteeCall = DaoTechnicalCommitteeCall_propose | DaoTechnicalCommitteeCall_propose_with_meta | DaoTechnicalCommitteeCall_vote | DaoTechnicalCommitteeCall_close | DaoTechnicalCommitteeCall_close_scheduled_proposal
