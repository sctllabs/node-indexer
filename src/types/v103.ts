 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type DaoCall = DaoCall_create_dao | DaoCall_approve_dao | DaoCall_update_dao_metadata | DaoCall_update_dao_policy | DaoCall_mint_dao_token | DaoCall_spend_dao_funds | DaoCall_launch_dao_referendum | DaoCall_bake_dao_referendum | DaoCall_subscribe | DaoCall_extend_subscription | DaoCall_change_subscription
...
export type Type_396 = Type_396_Standard | Type_396_Split

export interface Type_396_Standard {
    __kind: 'Standard'
    vote: number
    balance: bigint
}

export interface Type_396_Split {
    __kind: 'Split'
    aye: bigint
    nay: bigint
}
...
export type VersionedDaoSubscriptionDetails = VersionedDaoSubscriptionDetails_Default

export interface VersionedDaoSubscriptionDetails_Default {
    __kind: 'Default'
    value: DaoSubscriptionDetailsV1
}
...
export interface DaoSubscriptionDetailsV1 {
    duration: number
    price: bigint
    fnCallLimit: number
