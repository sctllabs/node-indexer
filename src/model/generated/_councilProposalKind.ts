...
export type CouncilProposalKind = AddMember | RemoveMember | Spend | TransferToken | CreateBounty | CreateTokenBounty | ProposeCurator | UnassignCurator | UpdateDaoMetadata | UpdateDaoPolicy | MintDaoToken
