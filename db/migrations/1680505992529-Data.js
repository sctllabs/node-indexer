module.exports = class Data1680505992529 {
    name = 'Data1680505992529'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "policy" ("id" character varying NOT NULL, "proposal_period" integer NOT NULL, "bounty_payout_delay" integer NOT NULL, "bounty_update_period" integer NOT NULL, "approve_origin_type" character varying(8) NOT NULL, "approve_origin_proportion" integer array NOT NULL, "governance" jsonb, CONSTRAINT "PK_9917b0c5e4286703cc656b1d39f" PRIMARY KEY ("id"))`)
        await db.query(`CREATE TABLE "council_proposal" ("id" character varying NOT NULL, "index" integer NOT NULL, "hash" text NOT NULL, "vote_threshold" integer NOT NULL, "kind" jsonb NOT NULL, "meta" text, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL, "block_hash" text NOT NULL, "block_num" integer NOT NULL, "status" character varying(11) NOT NULL, "account_id" character varying, "dao_id" character varying, CONSTRAINT "PK_f25908c1312a716ff9924bbae25" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "democracy_proposal" ("id" character varying NOT NULL, "index" integer NOT NULL, "deposit" numeric NOT NULL, "kind" jsonb NOT NULL, "meta" text, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL, "block_hash" text NOT NULL, "block_num" integer NOT NULL, "status" character varying(10) NOT NULL, "account_id" character varying, "dao_id" character varying, CONSTRAINT "PK_7a1e958ebe21dca11725bcd7e3c" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "democracy_referendum" ("id" character varying NOT NULL, "vote_threshold" character varying(20) NOT NULL, "status" character varying(9) NOT NULL, "index" integer NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL, "democracy_proposal_id" character varying, CONSTRAINT "PK_14e3134574e536d81ddc90d4a18" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "bounty" ("id" character varying NOT NULL, "tag" character varying(9) NOT NULL, "index" integer NOT NULL, "status" character varying(17) NOT NULL, "description" text NOT NULL, "value" numeric NOT NULL, "update_due" integer, "unlock_at" integer, "fee" numeric, "payout" numeric, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL, "dao_id" character varying, "curator_id" character varying, "beneficiary_id" character varying, CONSTRAINT "PK_afc9754b790b0effd1d59257f4d" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_519b98cc2e7cd575db2d85ac38" ON "bounty" ("dao_id") `)
        await db.query(`CREATE INDEX "IDX_81d35b2df3f7d7ecf605797bda" ON "bounty" ("curator_id") `)
        await db.query(`CREATE INDEX "IDX_f4f92297d9ae0fe553749b9a95" ON "bounty" ("beneficiary_id") `)
        await db.query(`CREATE TABLE "eth_governance_proposal" ("id" character varying NOT NULL, "index" integer NOT NULL, "hash" text NOT NULL, "vote_threshold" numeric NOT NULL, "kind" jsonb NOT NULL, "meta" text, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL, "block_hash" text NOT NULL, "block_num" integer NOT NULL, "status" character varying(11) NOT NULL, "account_id" character varying, "dao_id" character varying, CONSTRAINT "PK_db44e1c511aa802611ed7be6ba0" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_a9f1e48933416c17cc3fe01dd2" ON "eth_governance_proposal" ("account_id") `)
        await db.query(`CREATE INDEX "IDX_42d83a8beccf87125b3b1c47e3" ON "eth_governance_proposal" ("dao_id") `)
        await db.query(`CREATE TABLE "eth_governance_vote_history" ("id" character varying NOT NULL, "approved_vote" boolean NOT NULL, "aye" boolean, "balance" numeric, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL, "block_hash" text NOT NULL, "block_num" integer NOT NULL, "proposal_id" character varying, "account_id" character varying, CONSTRAINT "PK_dd7634851a35107bd243ada2cc4" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_e11f3e80b253b513ce0a124f71" ON "eth_governance_vote_history" ("proposal_id") `)
        await db.query(`CREATE INDEX "IDX_d76e16c313cf43e42b3024328b" ON "eth_governance_vote_history" ("account_id") `)
        ...
        await db.query(`ALTER TABLE "bounty" ADD CONSTRAINT "FK_519b98cc2e7cd575db2d85ac38b" FOREIGN KEY ("dao_id") REFERENCES "dao"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
        ...
        await db.query(`ALTER TABLE "eth_governance_proposal" ADD CONSTRAINT "FK_a9f1e48933416c17cc3fe01dd29" FOREIGN KEY ("account_id") REFERENCES "account"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
        await db.query(`ALTER TABLE "eth_governance_proposal" ADD CONSTRAINT "FK_42d83a8beccf87125b3b1c47e3d" FOREIGN KEY ("dao_id") REFERENCES "dao"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
        await db.query(`ALTER TABLE "eth_governance_vote_history" ADD CONSTRAINT "FK_e11f3e80b253b513ce0a124f711" FOREIGN KEY ("proposal_id") REFERENCES "eth_governance_proposal"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
        await db.query(`ALTER TABLE "eth_governance_vote_history" ADD CONSTRAINT "FK_d76e16c313cf43e42b3024328b2" FOREIGN KEY ("account_id") REFERENCES "account"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    }
    ...
    async down(db) {
        ...
        await db.query(`DROP INDEX "public"."IDX_519b98cc2e7cd575db2d85ac38"`)
        await db.query(`DROP INDEX "public"."IDX_81d35b2df3f7d7ecf605797bda"`)
        await db.query(`DROP INDEX "public"."IDX_f4f92297d9ae0fe553749b9a95"`)
        await db.query(`DROP TABLE "eth_governance_proposal"`)
        await db.query(`DROP INDEX "public"."IDX_a9f1e48933416c17cc3fe01dd2"`)
        await db.query(`DROP INDEX "public"."IDX_42d83a8beccf87125b3b1c47e3"`)
        await db.query(`DROP TABLE "eth_governance_vote_history"`)
        await db.query(`DROP INDEX "public"."IDX_e11f3e80b253b513ce0a124f71"`)
        await db.query(`DROP INDEX "public"."IDX_d76e16c313cf43e42b3024328b"`)
        ...
        await db.query(`ALTER TABLE "bounty" DROP CONSTRAINT "FK_519b98cc2e7cd575db2d85ac38b"`)
        ...
        await db.query(`ALTER TABLE "eth_governance_proposal" DROP CONSTRAINT "FK_a9f1e48933416c17cc3fe01dd29"`)
        await db.query(`ALTER TABLE "eth_governance_proposal" DROP CONSTRAINT "FK_42d83a8beccf87125b3b1c47e3d"`)
        await db.query(`ALTER TABLE "eth_governance_vote_history" DROP CONSTRAINT "FK_e11f3e80b253b513ce0a124f711"`)
        await db.query(`ALTER TABLE "eth_governance_vote_history" DROP CONSTRAINT "FK_d76e16c313cf43e42b3024328b2"`)
    }
}
